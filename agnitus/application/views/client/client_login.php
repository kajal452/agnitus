...
<div class="form-box" id="login-box">
            <div class="header">Client Login</div>
            <form name="adminLogin" action="<?php echo base_url(); ?>client/client_login" method="post">
               ...
               <?php echo $this->session->flashdata('notice'); ?>
                ...
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="userid" class="form-control" placeholder="Client Email"/>
                    </div>
                    <div class="form-group">
